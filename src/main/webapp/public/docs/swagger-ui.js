...
(function() {
  ...
  OperationView = (function(_super) {
    ...
    OperationView.ajaxAIStartTime= new Date().getTime();
    ...
    OperationView.prototype.showStatus = function(response) {
    	var totalTime = new Date().getTime()- OperationView.ajaxAIStartTime;
      ...
      $(".response_code", $(this.el)).html("<pre>" + response.status + "<br>Response Time: " + totalTime/1000 + " sec. </pre>" );
